...
- **Ops** — persistent sessions, **auto crash recovery** (a crashed page is recreated in the same context and restored to its last URL between calls), `storageState` auto-save, HAR record/replay, pixel `visual_diff`, human handoff for login/2FA.
...
[CLI](./docs/cli.md) ·
[MCP tools (28)](./docs/mcp-tools.md) ·
